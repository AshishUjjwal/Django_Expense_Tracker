...
SECRET_KEY = 'django-insecure-h-(y&oyj_x!u-*^t=ovv9=dq((r1mp(e+jz@&3^1dd9r!2bw#+'
...
#  How STATIC_ROOT Works?
# Let's say your project has this structure:
...
# All static files from all apps (like expensewebsite/static/, anotherapp/static/) will be copied to STATIC_ROOT:
...
#     │   ├── js/script.js
#     │   ├── images/logo.png
# Now, your web server (e.g., Nginx or Apache) can serve these files efficiently.
